...
{
    [Obsolete("可以刪掉了？")]
    public class PlayerActionIsPressCondition : AbstractConditionBehaviour
    {
        // string IValueProvider.Description => Description;

        public override string Description =>
            _actionRef ? _actionRef.action.name + " Is Pressed" : "No ActionRef";
        ...
        [FormerlySerializedAs("ActionRef")]
        public InputActionReference _actionRef; //好像要回去找中心化的input buffer dict,

        [PreviewInInspector]
        [AutoParent]
        PlayerInput playerInput; //FIXME: 要再抽一層，做角色控制的話，直接作為ConditionComp NPC會烙賽
