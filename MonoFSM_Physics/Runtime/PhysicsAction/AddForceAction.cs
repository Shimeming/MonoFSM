...
namespace MonoFSM_Physics.Runtime.PhysicsAction
{
    ...
    public class AddForceAction : AbstractStateAction, IArgEventReceiver<GeneralEffectHitData>
    {
        ...
        public void AddForceToRigidbody(Rigidbody target, Vector3 force)
        {
            ...
            // 確定力的施加位置
            Vector3 forcePosition = _forcePosition == ForcePosition.ActionPosition
                ? transform.position
        ...
        private void ExecuteForceAction(GeneralEffectHitData hitData = null, Transform fallbackRigidbodySource = null)
        {
        ...
        private Rigidbody GetTargetRigidbody(Transform fallbackSource = null)
        {
            ...
            // 其次使用 rigidbodyProvider
            if (_rigidbodyProvider != null)
            {
                return _rigidbodyProvider.Get<Rigidbody>();
            }
