...
namespace MonoFSM_Physics.Runtime
{
    ...
    public abstract class CompProviderFromVarMono<T> : MonoBehaviour, ICompProvider<T>
        where T : Component
    {
        [FormerlySerializedAs("_varBlackboard")]
        [FormerlySerializedAs("_varMono")]
        ...
        public string Description =>
            _varEntity != null ? "[VarMono]" + _varEntity.name : "No VarMono assigned";
    }
