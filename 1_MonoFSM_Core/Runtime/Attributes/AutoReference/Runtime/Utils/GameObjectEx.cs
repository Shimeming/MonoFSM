...
namespace Auto.Utils
{
    public static class GameObjectEx
    {
            ...
            where T : UnityEngine.Object
        {
            ...
            {
                throw new Exception(
                    "Use Transform instead of GameObject when calling GameObjectEx.FindAllOfType<>"
                );
            }
        ...
        /// </summary>
        public static T AddOrGetComponent<T>(this GameObject go, out bool wasComponentAdded)
            where T : Component
        {
        ...
        public static Component AddOrGetComponent(
            this GameObject go,
            Type componentType,
            out bool wasComponentAdded
        )
        {
        ...
        {
            foreach (
                var component in go.GetComponentsInChildren(componentType, includeInactiveObjects)
            )
            {
        ...
        public static T[] GetComponents<T>(this GameObject go, bool includeInactiveObjects)
            where T : Component
        {
        ...
        public static Component GetComponentInParent<T>(
            this GameObject go,
            bool includeInactiveObjects
        )
            where T : Component
        ...
        /// </summary>
        public static T GetRequiredComponent<T>(
        ...
        )
        {
            ...
            if (retrievedComponent is Component == false)
            {
                string msg = string.Format(
                    "Script {1} on GameObject \"{0}\" does not have the required component of type {2}",
                    thisGameobject.name,
                    typeof(T).Name,
                    typeof(T)
                );
        ...
        {
            var retrievedComponent = thisGameobject.GetComponentInChildren<T>(
                includeInactiveObjects
            );
            if (retrievedComponent != null)
            {
                string msg = string.Format(
                    "Script {1} on GameObject \"{0}\" does not have a child with component of type {2}",
                    thisGameobject.name,
                    thisGameobject.GetType(),
                    typeof(T)
                );
                throw new Exception(msg);
            }
        ...
        public static T GetRequiredComponentInParent<T>(this GameObject thisGameobject)
        {
            ...
            {
                string msg = string.Format(
                    "Script {1} on GameObject \"{0}\" does not have a parent with component of type {2}",
                    thisGameobject.name,
                    thisGameobject.GetType(),
                    typeof(T)
                );
    ...
    namespace OranUnityUtils
    {
        public static class GameObjectEx1
        {
            ...
            /// </summary>
            public static T GetComponentInParentExceptThis<T>(this GameObject go)
                where T : Component
            {
            ...
            /// </summary>
            public static T GetComponentInChildrenExceptThis<T>(this GameObject go)
                where T : Component
            {
            ...
            /// </summary>
            public static T[] GetComponentsInParentExceptThis<T>(this GameObject go)
                where T : Component
            {
                if (go.transform.parent == null)
                {
            ...
            /// </summary>
            public static T[] GetComponentsInChildrenExceptThis<T>(this GameObject go)
                where T : Component
            {
                return go.GetComponentsInChildren<T>()
                    .Where(myGo => myGo.gameObject != go)
                    .ToArray();
            }
        }
    }
