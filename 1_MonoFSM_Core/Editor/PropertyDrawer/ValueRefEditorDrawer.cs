    ...
    public class ValueRefEditorDrawer : BasePathEditorDrawer<ValueRef>
    {
        ...
        private void DrawSimplifiedEditor(ValueRef valueRef, GUIContent _ = null)
        {
            ...
            if (valueProvider != null)
                DrawSimplifiedPathEditor(
                    valueRef,
                    valueProvider.ValueType,
                    "valueProvider.ValueType = null"
                );
            else
        ...
        private void DrawValueProviderSelector(ValueRef _)
        {
            ...
            var valueProviderProperty = targetProperty.Children.FirstOrDefault(p =>
                p.Name == nameof(_target._valueProvider)
            );
