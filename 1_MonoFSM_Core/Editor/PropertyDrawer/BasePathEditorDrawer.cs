...
namespace MonoFSM.Core.Editor
{
    ...
    /// </summary>
    public abstract class BasePathEditorDrawer<T> : OdinEditor
        where T : PropertyOfTypeProvider
    {
        ...
        protected void SetUseSimplePathEditor(PropertyOfTypeProvider target, bool value)
        {
            var field = target
                .GetType()
                .GetField("UseSimplePathEditor", BindingFlags.Public | BindingFlags.Instance);
        ...
        protected List<FieldPathEntry> GetPathEntries(PropertyOfTypeProvider target)
        {
            var field = target
                .GetType()
                .GetField("_pathEntries", BindingFlags.Public | BindingFlags.Instance);
        ...
        /// 繪製簡化的路徑編輯器
        /// </summary>
        protected void DrawSimplifiedPathEditor(
            PropertyOfTypeProvider target,
            Type rootType,
            string noRootTypeMessage = "無法確定根型別"
        )
        {
        ...
        /// 繪製路徑操作按鈕
        /// </summary>
        protected void DrawPathOperationButtons(
            PropertyOfTypeProvider target,
        ...
        /// 繪製路徑片段
        /// </summary>
        protected List<FieldPathEntry> DrawPathSegments(
        ...
        /// 顯示屬性選擇器
        /// </summary>
        protected void ShowPropertySelector(
            Type currentType,
