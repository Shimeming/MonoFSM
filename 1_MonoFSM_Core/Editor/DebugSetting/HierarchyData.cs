...
namespace Febucci.HierarchyData
{
    public class HierarchyData : ScriptableObject
    {
        ...
        public class IconsData
        {
            ...
            public HierarchyElement[] pairs = Array.Empty<HierarchyElement>();
        }
        [System.Serializable]
        public class BackgroundData
        {
            ...
            public struct HierarchyElement
            {
                [SerializeField] public MonoScript targetScript;
        ...
        public BackgroundData bgColors;
        #endregion
        ...
        public class SeparatorData
        {
            ...
            public Color ProSkinColor = new(0, 1, 1, .15f);
            public Color bgColor => EditorGUIUtility.isProSkin ? ProSkinColor : color;
            public Color textColor => EditorGUIUtility.isProSkin ? Color.white : Color.black;
        }
        public SeparatorData separator;

        public SeparatorData Separator => separator;
